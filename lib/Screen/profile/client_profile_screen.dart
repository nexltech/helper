...
class _ClientProfileScreenState extends State<ClientProfileScreen> {
  ...
  Future<void> _submitProfile() async {
    ...
    try {
      final response = await ProfileApiService.registerHireHelp(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 18),
              _sectionTitle('Eligibility', underline: true),
              const SizedBox(height: 8),
              ...eligibility.keys
                  .map((q) => _buildEligibilityToggle(q))
                  ,
              const SizedBox(height: 18),
              _sectionTitle('Verification', underline: true),
              const SizedBox(height: 8),
              _buildPhotoIdField(),
              const SizedBox(height: 10),
              // _buildTextField('Resume', null,
              //     prefixIconPath: 'assets/Icons/Resume.png',
  ...
  Widget _sectionTitle(String title, {bool underline = false}) {
    return Text(
      title,
      style: TextStyle(
        fontFamily: underline ? null : 'BioRhyme',
        fontSize: underline ? 16 : 18,
        color: Colors.black,
