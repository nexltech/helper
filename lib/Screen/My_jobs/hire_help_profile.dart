...
class HireHelpProfileScreen extends StatefulWidget {
  const HireHelpProfileScreen({super.key});

  @override
  State<HireHelpProfileScreen> createState() => _HireHelpProfileScreenState();
}

class _HireHelpProfileScreenState extends State<HireHelpProfileScreen> {
            ...
            _buildNestedContainer(
              ...
              () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const SecurityDataProtectionScreen(),
                  ),
                );
              },
            ),
  ...
  void _logout() async {
    try {
      ...
      if (mounted) {
        print('HireHelpProfile: Navigating to LoginOrCreateScreen after logout');
      ...
      // Navigate to login screen
        ...
        print('HireHelpProfile: Navigation to LoginOrCreateScreen completed');
      }
    } catch (e) {
